            ...
            <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleLogin} className="space-y-8 relative z-10">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center px-1">
                                ...
                                <Link href="#" className="text-xs font-bold text-primary hover:text-primary-light transition-colors">
                                    Forgot password?
                                </Link>
                            </div>
                            <div className="relative group/input">
                        ...
                        {error && (
                            <div className="bg-red-500/10 border border-red-500/20 text-red-400 p-4 rounded-2xl text-sm font-medium animate-fade-in flex items-center gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="crypto-button-primary w-full text-lg py-5"
                        >
                ...
                <div className="mt-10 text-center animate-fade-in" style={{ animationDelay: '0.2s' }}>
                    <p className="text-sm text-muted font-medium">
                        ...
                        <Link href="/register" className="text-primary font-bold hover:text-primary-light transition-all underline-offset-4 hover:underline">
                            Register now
                        </Link>
                    </p>
                </div>
