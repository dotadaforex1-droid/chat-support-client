            ...
            <main className="max-w-6xl mx-auto px-8 pt-12">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
                    <div className="space-y-1">
                        <h1 className="text-4xl font-black tracking-tight bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent text-center md:text-left">
                            Support Tickets
                        </h1>
                        <p className="text-muted font-medium opacity-80 text-center md:text-left">
                    ...
                    <Link
                        ...
                        className="crypto-button-primary px-8 py-5 text-lg self-center md:self-end group"
                    >
                ...
                {loading ? (
                    ...
                    <div className="crypto-glass rounded-[3rem] p-20 text-center border-white/[0.04] animate-fade-in">
                        <div className="w-24 h-24 bg-primary/10 rounded-[2.5rem] border border-primary/20 flex items-center justify-center mx-auto mb-8 shadow-blue-glow">
                            <MessageSquare className="w-12 h-12 text-primary/60" />
                        </div>
                        <h3 className="text-2xl font-black mb-3">No active tickets</h3>
                        <p className="text-muted mb-10 max-w-sm mx-auto font-medium">Start a conversation with our elite support team by creating your first ticket.</p>
                        <Link
                            href="/dashboard/tickets/new"
                            className="crypto-button-primary inline-flex px-10"
                        >
                            Open A Ticket
                        </Link>
                    </div>
                    ...
                    <div className="grid gap-6">
                        {tickets.map((ticket, index) => (
                            <Link
                                ...
                                className="crypto-glass p-8 rounded-[2.5rem] border-white/[0.04] hover:border-primary/30 hover:bg-white/[0.05] transition-all group relative overflow-hidden animate-fade-in"
                                ...
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-muted font-medium line-clamp-1 opacity-70">
